...
import DeliveryProofPage from './pages/partner/DeliveryProofPage';
    ...
    <BrowserRouter>
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route
            element={
              <RoleGuard allow={['CUSTOMER', 'DELIVERY_PARTNER']} />
            }
          >
            <Route
              path="/orders/:orderId"
          ...
          <Route element={<RoleGuard allow={['DELIVERY_PARTNER']} />}>
            ...
            <Route
              path="/partner/delivery-proof/:orderId"
              element={<DeliveryProofPage />}
            />
          </Route>
